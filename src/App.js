...
function processEntries(data) {
   let entries = map(data, (entry,idx) => { 
     ...
     thumb = "https://drive.usercontent.google.com/download?id=" + thumb;
     poster = "https://drive.usercontent.google.com/download?id=" + poster;
...
function App() {
  ...
  useEffect(() => { 
       Papa.parse('https://docs.google.com/spreadsheets/d/e/2PACX-1vSKSQCO0B-t_majMAqfuixwNY3DGNb0tF9r81wk2e7D8yPcXUounkyh21tTlB81HdZLDI897mzaiMVp/pub?gid=626739284&single=true&output=csv', {
          download: true,
          header: true,
